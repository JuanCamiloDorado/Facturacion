...
class SaleCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    permission_required = 'core.add_sale'
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search_products':
                ...
                prods = Product.objects.filter(name__icontains=request.POST['term'].strip(), stock__gt=0)
...
class SaleListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('core:sale_create')
        context['list_url'] = reverse_lazy('core:sale_list')
        context['entity'] = 'Ventas'
        return context
...
class SaleDeleteView(LoginRequiredMixin, ValidatePermissionRequiredMixin, DeleteView):
    ...
    success_url = reverse_lazy('core:sale_list')
    permission_required = 'core.delete_sale'
    url_redirect = success_url
...
class SaleInvoicePdfView(View):
    ...
    def get(self, request, *args, **kwargs):
        try:
            template1 = get_template('sale/invoice.html')
            context = {
                       'sale': Sale.objects.get(pk=kwargs['pk']),
                       'comp':{'name': 'TIENDAS D1 S.A', 'ruc':'13061306', 'address': 'Cali, Colombia'},
                       'icon': '{}{}'.format(settings.MEDIA_URL, 'logo.png')
                       }

            html = template1.render(context)
